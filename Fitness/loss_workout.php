...
$sql = "SELECT * FROM wtloss ORDER BY FIELD(day, 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday')";
...
<head>
    ...
    <title>Weight Loss Workouts | Makefit</title>
