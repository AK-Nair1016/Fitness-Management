...
$sql = "SELECT * FROM wtgain ORDER BY FIELD(days, 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday')";
...
<head>
    ...
    <title>Weight Gain Workouts | Makefit</title>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                if ($row["days"] !== $currentDay) {
                                    ...
                                    echo "<td colspan='5'><strong>{$row["days"]}</strong></td>"; // Display the day in a merged cell
                                    echo "</tr>";
                                    $currentDay = $row["days"]; // Update the current day
                                }
